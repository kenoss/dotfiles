(define generic-on-key '("<Control>hiragana-katakana"))
(define generic-on-key? (make-key-predicate '("<Control>hiragana-katakana")))
(define generic-off-key '("hiragana-katakana"))
(define generic-off-key? (make-key-predicate '("hiragana-katakana")))
