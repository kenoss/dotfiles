(define generic-on-key '("<Super>Henkan_Mode"))
(define generic-on-key? (make-key-predicate '("<Super>Henkan_Mode")))
(define generic-off-key '("<Super> "))
(define generic-off-key? (make-key-predicate '("<Super> ")))
